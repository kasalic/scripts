...
DEFAULT_LD_LABEL = "com.dwr.deferred-policy"
...
You may schedule these updates for a convenient time by choosing
when to start installation.
"""
...
GUI_E_MESSAGE = ("A problem occurred processing your request. Please contact "
                 "your IT on ext 290 for assistance.")
